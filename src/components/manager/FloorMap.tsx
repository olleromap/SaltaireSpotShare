...
export default function FloorMap({ floor, grid, spots }: Props) {
  ...
  return (
    <div className="overflow-x-auto pb-2">
      {/* Single CSS grid — guarantees every column is perfectly aligned */}
      <div
      ...
      >
        {cells.map((cell, i) => {
          ...
          return (
            ...
            >
              <div
                className={`h-9 w-9 rounded flex flex-col items-center justify-center text-[9px] font-semibold cursor-pointer transition-all hover:scale-110 hover:shadow-md border ${
                  handicapped
